...
ChromeDriver driver = new ChromeDriver();
	...
	public void rightClick() throws InterruptedException {
		...
		action.contextClick(driver.findElement(By.xpath("//span[text()='right click me']"))).keyDown(Keys.DOWN).keyDown(Keys.DOWN).keyDown(Keys.DOWN).keyDown(Keys.ENTER).build().perform();
